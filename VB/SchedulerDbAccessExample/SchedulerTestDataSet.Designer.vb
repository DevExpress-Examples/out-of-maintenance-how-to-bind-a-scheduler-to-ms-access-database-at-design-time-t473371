...
Namespace SchedulerDbAccessExample
    ...
    Partial Public Class SchedulerTestDataSet
        ...
        Partial Public Class AppointmentsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String) As AppointmentsRow
                Dim rowAppointmentsRow As AppointmentsRow = (DirectCast(Me.NewRow(), AppointmentsRow))
                Dim columnValuesArray() As Object = { Nothing, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZoneId}
        ...
        Partial Public Class ResourcesDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddResourcesRow(ByVal ResourceID As String, ByVal ResourceName As String, ByVal Color As Integer, ByVal Picture() As Byte) As ResourcesRow
                Dim rowResourcesRow As ResourcesRow = (DirectCast(Me.NewRow(), ResourcesRow))
                Dim columnValuesArray() As Object = { Nothing, ResourceID, ResourceName, Color, Picture}
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function FindByIDResourceID(ByVal ID As Integer, ByVal ResourceID As String) As ResourcesRow
                Return (CType(Me.Rows.Find(New Object() { ID, ResourceID}), ResourcesRow))
            End Function
            ...
            Private Sub InitClass()
                ...
                Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() { Me.columnID, Me.columnResourceID}, True))
                Me.columnID.AutoIncrement = True
                Me.columnID.AutoIncrementSeed = -1
                Me.columnID.AutoIncrementStep = -1
                Me.columnID.AllowDBNull = False
                Me.columnResourceID.AllowDBNull = False
                Me.columnResourceID.MaxLength = 536870910
                Me.columnResourceName.MaxLength = 536870910
            End Sub
        ...
        Partial Public Class AppointmentsRow
            ...
            Public Property ID() As Integer
                Get
                    Return (DirectCast(Me(Me.tableAppointments.IDColumn), Integer))
                End Get
        ...
        Partial Public Class ResourcesRow
            ...
            Public Property ResourceID() As String
                Get
                    Return (DirectCast(Me(Me.tableResources.ResourceIDColumn), String))
                End Get
                Set(ByVal value As String)
            ...
            Public Property Picture() As Byte()
                Get
                    Try
                        Return (DirectCast(Me(Me.tableResources.PictureColumn), Byte()))
                    Catch e As Global.System.InvalidCastException
                        Throw New Global.System.Data.StrongTypingException("The value for column 'Picture' in table 'Resources' is DBNull.", e)
                    End Try
                End Get
                Set(ByVal value As Byte())
                    Me(Me.tableResources.PictureColumn) = value
                End Set
            End Property
            ...
            Public Function IsPictureNull() As Boolean
                Return Me.IsNull(Me.tableResources.PictureColumn)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Sub SetPictureNull()
                Me(Me.tableResources.PictureColumn) = Global.System.Convert.DBNull
            End Sub
        End Class
    ...
    End Class
End Namespace
Namespace SchedulerDbAccessExample.SchedulerTestDataSetTableAdapters
    ...
    Partial Public Class AppointmentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Appointments` WHERE ((`ID` = ?) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `StartDate` IS NULL) OR (`StartDate` = ?)) AND ((? = 1 AND `EndDate` IS NULL) OR (`EndDate` = ?)) AND ((? = 1 AND `AllDay` IS NULL) OR (`AllDay` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)) AND ((? = 1 AND `Label` IS NULL) OR (`Label` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Appointments` (`Type`, `StartDate`, `EndDate`, `AllDay`, `Subject`, " & "`Location`, `Description`, `Status`, `Label`, `ResourceIDs`, `ReminderInfo`, `Re" & "currenceInfo`, `TimeZoneId`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Subject", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Subject", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Location", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Location", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceIDs", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceIDs", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("TimeZoneId", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "TimeZoneId", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Appointments` SET `Type` = ?, `StartDate` = ?, `EndDate` = ?, `AllDay` = ?, `Subject` = ?, `Location` = ?, `Description` = ?, `Status` = ?, `Label` = ?, `ResourceIDs` = ?, `ReminderInfo` = ?, `RecurrenceInfo` = ?, `TimeZoneId` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `StartDate` IS NULL) OR (`StartDate` = ?)) AND ((? = 1 AND `EndDate` IS NULL) OR (`EndDate` = ?)) AND ((? = 1 AND `AllDay` IS NULL) OR (`AllDay` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)) AND ((? = 1 AND `Label` IS NULL) OR (`Label` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Subject", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Subject", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Location", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Location", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceIDs", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceIDs", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("TimeZoneId", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "TimeZoneId", Global.System.Data.DataRowVersion.Current, False, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.SchedulerDbAccessExample.Properties.Settings.Default.SchedulerTestConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Stat" & "us, Label, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZoneId FROM Appointmen" & "ts"
        ...
        Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Type As Integer, ByVal Original_StartDate As Date, ByVal Original_EndDate As Date, ByVal Original_AllDay As Boolean, ByVal Original_Status? As Integer, ByVal Original_Label? As Integer) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Original_Type))
            Me.Adapter.DeleteCommand.Parameters(3).Value = (DirectCast(0, Object))
            Me.Adapter.DeleteCommand.Parameters(4).Value = (CDate(Original_StartDate))
            Me.Adapter.DeleteCommand.Parameters(5).Value = (DirectCast(0, Object))
            Me.Adapter.DeleteCommand.Parameters(6).Value = (CDate(Original_EndDate))
            Me.Adapter.DeleteCommand.Parameters(7).Value = (DirectCast(0, Object))
            Me.Adapter.DeleteCommand.Parameters(8).Value = (CBool(Original_AllDay))
        ...
        Public Overridable Function Insert(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(Type))
            Me.Adapter.InsertCommand.Parameters(1).Value = (CDate(StartDate))
            Me.Adapter.InsertCommand.Parameters(2).Value = (CDate(EndDate))
            Me.Adapter.InsertCommand.Parameters(3).Value = (CBool(AllDay))
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(9).Value = (CStr(ResourceIDs))
            End If
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(12).Value = (CStr(TimeZoneId))
            End If
        ...
        Public Overridable Function Update(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal Original_ID As Integer, ByVal Original_Type As Integer, ByVal Original_StartDate As Date, ByVal Original_EndDate As Date, ByVal Original_AllDay As Boolean, ByVal Original_Status? As Integer, ByVal Original_Label? As Integer) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(Type))
            Me.Adapter.UpdateCommand.Parameters(1).Value = (CDate(StartDate))
            Me.Adapter.UpdateCommand.Parameters(2).Value = (CDate(EndDate))
            Me.Adapter.UpdateCommand.Parameters(3).Value = (CBool(AllDay))
            If (Subject Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = (CStr(ResourceIDs))
            End If
            If (ReminderInfo Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(TimeZoneId))
            End If
            Me.Adapter.UpdateCommand.Parameters(13).Value = (CInt(Original_ID))
            Me.Adapter.UpdateCommand.Parameters(14).Value = (DirectCast(0, Object))
            Me.Adapter.UpdateCommand.Parameters(15).Value = (CInt(Original_Type))
            Me.Adapter.UpdateCommand.Parameters(16).Value = (DirectCast(0, Object))
            Me.Adapter.UpdateCommand.Parameters(17).Value = (CDate(Original_StartDate))
            Me.Adapter.UpdateCommand.Parameters(18).Value = (DirectCast(0, Object))
            Me.Adapter.UpdateCommand.Parameters(19).Value = (CDate(Original_EndDate))
            Me.Adapter.UpdateCommand.Parameters(20).Value = (DirectCast(0, Object))
            Me.Adapter.UpdateCommand.Parameters(21).Value = (CBool(Original_AllDay))
            If (Original_Status.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(22).Value = (DirectCast(0, Object))
                Me.Adapter.UpdateCommand.Parameters(23).Value = (CInt(Original_Status.Value))
            Else
    ...
    Partial Public Class ResourcesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Resources` WHERE ((`ID` = ?) AND ((? = 1 AND `Color` IS NULL) OR (`C" & "olor` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ID", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ID", Global.System.Data.DataRowVersion.Original, False, Nothing))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Resources` (`ResourceID`, `ResourceName`, `Color`, `Picture`) VALUES" & " (?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceID", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceID", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceName", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceName", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Resources` SET `ResourceID` = ?, `ResourceName` = ?, `Color` = ?, `Pictur" & "e` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Color` IS NULL) OR (`Color` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceID", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceID", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceName", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceName", Global.System.Data.DataRowVersion.Current, False, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ID, ResourceID, ResourceName, Color, Picture FROM Resources"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
        Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Color? As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Original_ID))
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
        Public Overridable Function Insert(ByVal ResourceID As String, ByVal ResourceName As String, ByVal Color? As Integer, ByVal Picture() As Byte) As Integer
            If (ResourceID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ResourceID")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = (CStr(ResourceID))
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Function Update(ByVal ResourceID As String, ByVal ResourceName As String, ByVal Color? As Integer, ByVal Picture() As Byte, ByVal Original_ID As Integer, ByVal Original_Color? As Integer) As Integer
            If (ResourceID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ResourceID")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = (CStr(ResourceID))
            End If
            If (ResourceName Is Nothing) Then
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As SchedulerTestDataSet) As Integer
            ...
            Try
                ...
                If (Me._appointmentsTableAdapter IsNot Nothing) Then
                    ...
                    Me._appointmentsTableAdapter.Connection = (DirectCast(workConnection, Global.System.Data.OleDb.OleDbConnection))
                    Me._appointmentsTableAdapter.Transaction = (DirectCast(workTransaction, Global.System.Data.OleDb.OleDbTransaction))
                ...
                If (Me._resourcesTableAdapter IsNot Nothing) Then
                    ...
                    Me._resourcesTableAdapter.Connection = (DirectCast(workConnection, Global.System.Data.OleDb.OleDbConnection))
                    Me._resourcesTableAdapter.Transaction = (DirectCast(workTransaction, Global.System.Data.OleDb.OleDbTransaction))
            ...
            Finally
                ...
                End If
                If (Me._appointmentsTableAdapter IsNot Nothing) Then
                    Me._appointmentsTableAdapter.Connection = (DirectCast(revertConnections(Me._appointmentsTableAdapter), Global.System.Data.OleDb.OleDbConnection))
                    Me._appointmentsTableAdapter.Transaction = Nothing
                End If
                If (Me._resourcesTableAdapter IsNot Nothing) Then
                    Me._resourcesTableAdapter.Connection = (DirectCast(revertConnections(Me._resourcesTableAdapter), Global.System.Data.OleDb.OleDbConnection))
